        ...
        <div class="w-full xl:w-1/2 flex flex-col h-full">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 xl:gap-4">
            ...
            <div class="text-white">
              ...
              <div class="bg-gray-900/50 rounded-xl p-6 overflow-auto" :style="{ height: chartHeight }">
                <div class="mt-2 text-xs sm:text-sm md:text-sm lg:text-sm xl:text-sm 2xl:text-[18px]">
                ...
                <div class="flex items-center mt-10">
                  ...
                  <img src="../assets/icon-12.png" alt="Icon" class="w-[16px] mr-3 ml-3" />
                  <p class="text-xs sm:text-sm md:text-sm lg:text-sm xl:text-sm 2xl:text-[18px]">智能化</p>
                </div>
                <div class="mt-2 text-[12px] 2xl:text-[16px] leading-8">
                  <p class="flex mb-2"><img src="../assets/icon-13.png" alt="Icon" class="flex-shrink-0 w-[18px] h-[18px] mr-3 mt-1" />环保法规要求：全球主要国家海事均发布船舶零排放法规，未来将逐步禁止油船进入水域。</p>
                  <p class="flex mb-2"><img src="../assets/icon-14.png" alt="Icon" class="flex-shrink-0 w-[20px] h-[20px] mr-3 mt-1" />“三电”下放：中国电池、电机、电控技术&产业链随新能源汽车发展已成熟，三电技术将逐步下放其他交通工具领域，引领能源技术变革。目前主流船艇公司均逐步推出电动船艇产品，力图抢占市场。</p>
                  <p class="flex"><img src="../assets/icon-15.png" alt="Icon" class="flex-shrink-0 w-[20px] h-[20px] mr-3 mt-1" />智能化趋势：电动化不应是简单的“油转电”，而是全新品类的全面升级；在其他行业我们已经看到了智能化设计在不断颠覆并替代传统产品，算力芯片、AI技术已较为成熟，可快速迁移。</p>
                </div>
              </div>
            </div>
          </div>
