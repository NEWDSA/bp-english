...
const generateRegionData = () => {
  ...
  const regionData = {
    'China': {
      ...
      barData: [0.988, 0.982, 1.108, 1.08, 1.152, 1.226],
      xAxis: ['2019', '2020', '2021', '2022', '2023', '2024']
    },
    'Singapore': {
      detailed: ['hidden', -9.10, 18.70, 7.60, 9.00],
      barData: [5.28, 4.815, 7.29, 7.845, 8.55],
      xAxis: ['2019', '2020', '2022', '2023', '2024']
    },
    'Italy': {
      detailed: ['hidden', 17.66, 29.17, 4.50, 4.88, 4.90],
      barData: [2.881, 3.39, 4.379, 4.577, 4.8, 5.025],
      xAxis: ['2019', '2020', '2021', '2022', '2023', '2024']
    },
    'United States': {
      detailed: ['hidden', -3.30, 8.39, -5.12, 7.03, 5.82],
      barData: [16.174, 15.643, 16.957, 16.088, 17.219, 18.221],
      xAxis: ['2019', '2020', '2021', '2022', '2023', '2024']
    },
    'United Arab Emirates': {
      detailed: ['hidden', -3.30, 8.33, -5.13, 7.07, 7.00],
      barData: [9.677, 9.359, 10.145, 9.625, 10.302, 11.02],
      xAxis: ['2019', '2020', '2021', '2022', '2023', '2024']
    },
    'global': {
      detailed: ['hidden', -3.30, 8.40, -5.12, 7.03, 7.00],
      barData: [44.237, 42.785, 46.377, 44.001, 47.095, 50.393],
      xAxis: ['2019', '2020', '2021', '2022', '2023', '2024']
    }
